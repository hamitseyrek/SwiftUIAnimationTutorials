...
var tutorials = [
    ...
    TutorialModel(name: "Expand Button", animationView: AnyView(ExpandButtonView()), keys: "Ed Sherran", image: "ExpandButtonView"),
    TutorialModel(name: "Heart Animate", animationView: AnyView(HeartAnimateView()), keys: "Taylor Swift", image: "HeartAnimateView"),
    ...
    TutorialModel(name: "Flying Bird", animationView: AnyView(FlyingBirdView()), keys: "Camila Cabello", image: "FlyingBirdView"),
    TutorialModel(name: "Breathing Flower", animationView: AnyView(BreathingFlowerView()), keys: "Lady Gaga", image: "BreathingFlowerView"),
    TutorialModel(name: "FunColor Rotation", animationView: AnyView(FunColorRotationView()), keys: "Kay Perry", image: "FunColorRotationView"),
    TutorialModel(name: "Record Player", animationView: AnyView(RecordPlayerView()), keys: "Maren Morris", image: "RecordPlayerView"),
    TutorialModel(name: "Circle Animation", animationView: AnyView(CircleAnimationView()), keys: "Katy Perry", image: "CircleAnimationView"),
]
